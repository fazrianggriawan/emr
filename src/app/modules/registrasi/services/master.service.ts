...
export class MasterService {
    ...
    public getPoli() {
        this.http.get<any>(config.api_url('master/ruangan/rj')).subscribe(data => this.ruangan.next(data.data))
    }
    ...
    public getRuangan(idJnsPerawatan: string) {
        if (idJnsPerawatan) {
            this.http.get<any>(config.api_url('master/ruangan/' + idJnsPerawatan)).subscribe(data => this.ruangan.next(data.data))
        }
    }
    ...
    public getTempatTidur(idRuangan: string) {
        this.http.get<any>(config.api_url('master/tempatTidurByRuangan/' + idRuangan))
            .subscribe(data => {
                this.tempatTidur.next(data.data)
            })
    }
